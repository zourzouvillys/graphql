...
@javax.annotation.Generated(value = "io.zrz.graphql.generator.java.JavaClientGenerator", date = "2015-11-18T14:16:31.503Z")
public class MyTestClient {
  ...
  public interface ClientStub {
    ...
    io.zrz.graphql.client.runtime.RuntimeQuery<ListUsersAndPhoneNumbersResult> listUsersAndPhoneNumbers(
        @io.zrz.graphql.client.runtime.GQLParamName("userSearch") String userSearch,
        @io.zrz.graphql.client.runtime.GQLParamName("numberFormat") String numberFormat);

    io.zrz.graphql.client.runtime.RuntimeQuery<GetUserResult> getUser(@io.zrz.graphql.client.runtime.GQLParamName("username") String username,
        @io.zrz.graphql.client.runtime.GQLParamName("numberFormat") String numberFormat);

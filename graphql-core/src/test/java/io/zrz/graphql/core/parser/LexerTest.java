...
public class LexerTest {
  ...
  public void test() {
    ...
    assertThat(toks.get(0)).isEqualTo(Token.fragmentSpread(SourcePosition.range(1, 4)));
    assertThat(toks.get(1)).isEqualTo(Token.name("fragment", SourcePosition.range(5, 13)));
    assertThat(toks.get(2)).isEqualTo(Token.name("on", SourcePosition.range(14, 16)));
